...
// the `internal` variable is nested within the `myFunction` function, allowing it to be utialized by anything after it, due to the cascading two pass nature of JS!
